    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-right-8 duration-500">
            <div className="text-center mb-6">
                ...
                <h1 className="text-2xl font-black text-foreground uppercase tracking-tight">CONFIRM DETAILS</h1>
                <p className="text-muted-foreground text-sm">Review your profile information.</p>
            </div>
