...
assert.ok(
  routeSource.includes("Controlled Submaximal / Maintenance Strength: Must remain an active option when context supports it"),
...
assert.ok(
  routeSource.includes("Base Heuristic: RPE <= 7 may be used as the current BASE_COACHING_HEURISTIC for this session type, not an immutable rule. Established athlete-specific evidence may supersede it through the existing epistemic architecture"),
...
console.log("=================================================");
console.log("ALL 9 CALIBRATION & CONVERSATIONAL UX TESTS PASSED (100%)");
console.log("=================================================");
