        ...
        if (performance.stability && performance.stability < 70) {
            matches.push({
                ...
                recommendation: {
                    ...
                    reason: "Focus on building a solid performance foundation today. Steady reps only.",
                    videoWait: 0,
                    drill: {
        ...
        if (performance.readiness && performance.readiness < 60) {
            matches.push({
                ...
                recommendation: {
                    ...
                    reason: "Prioritizing recovery and neural flow to ensure peak readiness today.",
                    videoWait: 0,
                    drill: {
