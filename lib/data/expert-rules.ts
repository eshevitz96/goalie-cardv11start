...
export const EXPERT_RULES: ExpertRule[] = [
    ...
    // --- 6. STATS-BASED INSIGHTS (Triggered by Keywords from Stats Summary) ---
    {
        ...
        recommendation: {
            ...
            reason: "Focus on early eye-attachment and tracking fundamentals today. Aim for visual lock on every release.",
            videoWait: 0
        }
    },
    {
        ...
        recommendation: {
            ...
            reason: "Prioritize defensive communication today. Be the primary voice in the d-zone transition.",
            videoWait: 0
        }
    },
    ...
    },
    {
        ...
        recommendation: {
            ...
            reason: "Prioritizing high-intensity, low-volume work to manage neural load and recovery today.",
            videoWait: 0
        }
    },
