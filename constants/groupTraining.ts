export const GROUP_TRAINING_CONFIG = {
    // Access codes that are valid for the flow
    validCodes: ['GOALIE092026'],
...
1) The risk of injury from the activities involved in this group program is significant, including the potential for permanent paralysis and death, and while particular rules, equipment, and personal discipline may reduce this risk, the risk of serious injury does exist; and,

2) I KNOWINGLY AND FREELY ASSUME ALL SUCH RISKS, both known and unknown, EVEN IF ARISING FROM THE NEGLIGENCE OF THE RELEASEES or others, and assume full responsibility for my participation; and,

3) I willingly agree to comply with the stated and customary terms and conditions for participation alongside other athletes. If, however, I observe any unusual significant hazard during my presence or participation, I will remove myself from participation and bring such to the attention of the nearest official immediately; and,
...
4) I, for myself and on behalf of my heirs, assigns, personal representatives and next of kin, HEREBY RELEASE AND HOLD HARMLESS the Releasees, their officers, officials, agents, and/or employees, other participants, sponsoring agencies, sponsors, advertisers, and if applicable, owners and lessors of premises used to conduct the event ("RELEASEES"), WITH RESPECT TO ANY AND ALL INJURY, DISABILITY, DEATH, or loss or damage to person or property, WHETHER ARISING FROM THE NEGLIGENCE OF THE RELEASEES OR OTHERWISE, to the fullest extent permitted by law.`,
        ...
        paymentPolicy: `By signing below, I acknowledge that I have voluntarily enrolled in group services provided by The Goalie Brand:
1. Payment Requirement: Full payment is required in advance to reserve any spot in the September Group Training clinic/event.
